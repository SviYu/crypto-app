      ...
      {loading ? <Loader /> : (
        <>
          ...
          <HStack p={"4"} overflowX={"auto"}>
            {
              btns.map((i) => {
                return <Button key={i.id} onClick={() => switchChartStats(i)} m={"2"}>{i}</Button>
              })
            }
          </HStack>
          ...
          <VStack spacing={"4"} p={"10"} alignItems={"flex-start"}>
            <Text fontSize={"small"} alignSelf={"center"} opacity={"0.7"} paddingBottom={"5"} textAlign={"center"}>
            ...
            <CustomBar
              ...
              /* progressValue={coin.market_data.current_price[currency]} */
            />
